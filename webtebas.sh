...
sleep 0.1;
clear
figlet -f future "Iklan Lewat" | lolcat
sleep 1
clear
sl
echo  $green
echo 'Sabar Yah Ngentod.................';
sleep 0.1;
clear
echo  $red
echo 'Harap Sabar Dulu Ye kan............................................';
sleep 0.4;
echo  $green
echo "Loading..................................";
sleep 0.1;
...
sleep 0.1;
clear
figlet -f future "Iklan Lewat"
sleep 3
clear
figlet -f future "Sabar Yah Goblok..." | lolcat
sleep 5
clear
echo
echo
...
echo
echo
toilet -f standard "Team TCN" -F gay
echo
echo $yellow"#####################$red" WELCOME "$yellow#####################"
echo $yellow
figlet -f future "Tools Tebas Index" | lolcat
echo
echo $yellow"#####################$red" WELCOME "$yellow######################"
echo
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"Mr.Shadow"$cyan" ~/Cyber_TCN"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo
echo
toilet -f future "Tools Team TCN" | lolcat
echo
...
echo $green "╭─"$blue"Mr.Shadow"$cyan" ~/Cyber_TCN"$white
read -p " ╰─$ "  target
echo
echo $red "Masukan Script!!! "
echo $green "╭─"$blue"Mr.Shadow"$cyan" ~/Nama SC Harus(index.html)"$white
read -p " ╰─$ "  script
...
echo
echo $red
toilet -f future "Gunakan Dengan Bijak" | lolcat
echo $cyan "Deface Web Sebanyak Banyak nya"
echo
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"Mr.Shadow"$cyan" ~/Cyber_TCN"$white                               
read -p " ╰─$ " script
echo
echo
...
echo $white "╭─"$green"Chemod@zrd404"$cyan" ~/Cyber_TCN"$white
read -p " ╰─$ " target20
...
echo
echo
toilet -f future "   Data Tools" | lolcat
echo $yellow"#######################$red" WELCOME "$yellow#####################"
echo $green"Author  : 		Mr.Bat_Clay	"
echo $purple"Nama Team Author   : Team Cyber Noobs"
echo $yellow"Team    :         Team Newbie Terlupakan"
echo $red"Editor Tools   :     Mr.ALF & Mr.Shadow"
echo
echo $yellow"                       THANKS TO : Allah"
echo
echo $cyan"[+] MR.Cold_Ice & Queen L.K.A "
echo $cyan"[+] MR.ANR "
echo $cyan"[+] Exone Lee & All Member [T.C.N] "
echo $yellow"########################$red" WELCOME "$yellow####################"
...
echo "Silahkan Gunakan Tools Kami Lagi :) "
exit
clear
fi
